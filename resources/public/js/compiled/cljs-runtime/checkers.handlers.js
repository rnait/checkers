...
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59997__$1,new cljs.core.Keyword(null,"from","from",1815293044));
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59997__$1,new cljs.core.Keyword(null,"to","to",192099007));
var captureLocation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59997__$1,new cljs.core.Keyword(null,"captureLocation","captureLocation",1730093554));
var G__59999 = new cljs.core.Keyword(null,"typeOfMove","typeOfMove",1686461361).cljs$core$IFn$_invoke$arity$1(move);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"move","move",-2110884309),G__59999)){
return checkers.handlers.move_piece_handler(cofx,from,to);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"capture","capture",-677031143),G__59999)){
return checkers.handlers.capture_piece_handler(cofx,from,to,captureLocation);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__59999)){
return cofx;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59999)].join('')));

}
}
}
});
checkers.handlers.show_piece_moves = (function checkers$handlers$show_piece_moves(db,p__60000){
var vec__60001 = p__60000;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60001,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60001,(1),null);
