...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,(function (){var iter__4529__auto__ = (function checkers$ai$pawn_pos_score_$_iter__55878(s__55879){
return (new cljs.core.LazySeq(null,(function (){
var s__55879__$1 = s__55879;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55879__$1);
if(temp__5735__auto__){
var s__55879__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55879__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__55879__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__55881 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__55880 = (0);
while(true){
if((i__55880 < size__4528__auto__)){
var vec__55882 = cljs.core._nth(c__4527__auto__,i__55880);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55882,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55882,(1),null);
cljs.core.chunk_append(b__55881,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(v,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"color","color",1011675173),"b",new cljs.core.Keyword(null,"name","name",1843675177),"p"], null)))?((-1) * ((k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1((0)) : k.call(null,(0))) * (k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1((0)) : k.call(null,(0))))):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(v,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"color","color",1011675173),"w",new cljs.core.Keyword(null,"name","name",1843675177),"p"], null)))?(((7) - (k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1((0)) : k.call(null,(0)))) * ((7) - (k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1((0)) : k.call(null,(0))))):(0)
)));

var G__55911 = (i__55880 + (1));
i__55880 = G__55911;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55881),checkers$ai$pawn_pos_score_$_iter__55878(cljs.core.chunk_rest(s__55879__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55881),null);
}
} else {
var vec__55885 = cljs.core.first(s__55879__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55885,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55885,(1),null);
return cljs.core.cons(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(v,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"color","color",1011675173),"b",new cljs.core.Keyword(null,"name","name",1843675177),"p"], null)))?((-1) * ((k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1((0)) : k.call(null,(0))) * (k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1((0)) : k.call(null,(0))))):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(v,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"color","color",1011675173),"w",new cljs.core.Keyword(null,"name","name",1843675177),"p"], null)))?(((7) - (k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1((0)) : k.call(null,(0)))) * ((7) - (k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1((0)) : k.call(null,(0))))):(0)
)),checkers$ai$pawn_pos_score_$_iter__55878(cljs.core.rest(s__55879__$2)));
}
} else {
return null;
}
...
var G__55888 = checkers.handlers.execute_move(cofx,move);
var G__55889 = (depth - (1));
return (checkers.ai.minimax.cljs$core$IFn$_invoke$arity$2 ? checkers.ai.minimax.cljs$core$IFn$_invoke$arity$2(G__55888,G__55889) : checkers.ai.minimax.call(null,G__55888,G__55889));
}),moves);
...
var score = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__55890,move){
var vec__55891 = p__55890;
var alpha = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55891,(0),null);
var beta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55891,(1),null);
var best = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55891,(2),null);
...
var newBest = (function (){var G__55897 = best;
var G__55898 = (function (){var G__55899 = movedDb;
var G__55900 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(moveType,new cljs.core.Keyword(null,"capture","capture",-677031143)))?depth:(depth - (1)));
var G__55901 = alpha;
var G__55902 = beta;
return (checkers.ai.minimax_reduce.cljs$core$IFn$_invoke$arity$4 ? checkers.ai.minimax_reduce.cljs$core$IFn$_invoke$arity$4(G__55899,G__55900,G__55901,G__55902) : checkers.ai.minimax_reduce.call(null,G__55899,G__55900,G__55901,G__55902));
})();
return (compOperator.cljs$core$IFn$_invoke$arity$2 ? compOperator.cljs$core$IFn$_invoke$arity$2(G__55897,G__55898) : compOperator.call(null,G__55897,G__55898));
})();
var vec__55894 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(player,"w"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var x__4214__auto__ = newBest;
...
var newAlpha = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55894,(0),null);
var newBeta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55894,(1),null);
if((beta <= alpha)){
