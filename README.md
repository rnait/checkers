...
* [`src/cljs/checkers/`](src/cljs/checkers/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/checkers/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `checkers` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/checkers/config.cljs) defaults to `true` in
...
```clj
(ns checkers.example
  (:require [checkers.config :as config])
